...
internal data class AdminReportsSeedState(
	val publicationsById: androidx.compose.runtime.snapshots.SnapshotStateMap<String, PuntoInteres>,
	val pendingReports: androidx.compose.runtime.snapshots.SnapshotStateList<AdminReportSeedEntry>,
	val acceptedReportsCountByPublication: androidx.compose.runtime.snapshots.SnapshotStateMap<String, Int>
)
